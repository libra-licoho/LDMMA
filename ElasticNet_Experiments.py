...
from ElasticNet_Algorithms import iP_DCA, Bayesian_Method, Grid_Search, Random_Search, IGJO, LDMMA
...
#%%
def main():
    np.random.seed(45) # for reproduction
    num_repeat = 1
    num_train = 100
    num_validate = 20
    num_test = 250
