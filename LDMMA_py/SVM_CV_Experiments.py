...
import numpy as np
import pandas as pd
from SVM_CV_Algorithms import iP_DCA, Random_Search, Grid_Search, Bayesian_Method, Bayesian_Method_Simple, LDMMA
from Data_Generator import Data_Generator_Wrapper, CV_Real_Data_Setting, CV_Real_Data_Fetcher
    ...
    for dataset in datasets:
        ...
        for i in range(num_repeat):
            ...
            if  "MM" in Methods:
                ...
                Result_MM.to_pickle(result_path + "/svm/MM_" + str(data_info.data_index) + marker + ".pkl")
